...
import LoginCredentials.LoginAngel;

public class Company_Details extends LoginAngel{
	...
	public static void main(String[] args) {
       ...
       String companyName= driver.findElement(By.cssSelector("h1[class='u-fontWeight500 s-vgBottom0_5']")).getText();
           ...
           String companyShortDesc= driver.findElement(By.cssSelector("h2[class='js-startup_high_concept u-fontSize15 u-fontWeight400 u-colorGray3']")).getText();
           ...
           try {
        	    String companyLink=driver.findElement(By.xpath("//a[contains(@class,'u-uncoloredLink company_url')]")).getText();
           ...
           List<WebElement> foundersLink= driver.findElements(By.xpath(founderUrl));
        			   ...
        			   //for(WebElement founderInfoDetails:foundersLink)
        			   {
        					   System.out.println("Founder Details URL"+itr_url.next().getAttribute("href"));
        				  
        				   //founderUniqueDetails.add(founderInfoDetails.getAttribute("href"));
        			   }
        			   }
           ...
           try {
        	   ...
        	   wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//div[@class='founders section']//div[@class='bio']/p")));
           }
           catch(IndexOutOfBoundsException e)
           {
        	   e.printStackTrace();
